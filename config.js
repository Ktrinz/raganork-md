...
module.exports = {
    VERSION: 'V 2.0.1',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg Hey {sender}, njan jeevanode undee \n Uptime: {uptime}",
    ...
    BOT_NAME: process.env.BOT_NAME || '[°ktrinπ]✓',
    ...
    SUDO: process.env.SUDO || '917560820366,0',
